            ...
            switch (detail.type) {
              case "point": {
                return {
                  ...
                  value: moneyFormatter(detail.y),
                  expandable: detail.series.name === "Others",
                  subItems:
                    detail.series.name === "Others"
                      ? [
                          {
                            key: "AWS Lambda",
                            value: moneyFormatter([10.89, 11.25, 10.89, 11.25, 11.25, 10.89][detail.x]),
                          },
                          {
                            key: "CodeBuild",
                            value: moneyFormatter([6.42, 9.52, 19.06, 17.92, 7.22, 6.08][detail.x]),
                          },
                          {
                            key: "Amazon GuardDuty",
                            value: moneyFormatter([10, 12.83, 11.13, 8.2, 7.02, 8.31][detail.x]),
                          },
                        ]
                      : undefined,
                };
